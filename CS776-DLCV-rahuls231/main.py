...
if __name__ == "__main__":
    ...
    ap.add_argument("-d", "--dataset", default='./cifar-10-batches-py', required=True,
    ...
    ap.add_argument("-l", "--learning_rate", default=0.01, type=float, required=True,
                    help="Learnng rate used to train the model")
    ...
    unaugmented_model = Model(original_train_feat_vec, train_labels, original_test_feat_vec, test_labels, model_weights,
                              out_folder, \
                              isModelWeightsAvailable=args['isModelWeightsAvailable'], epochs=args['epochs'],
                              batch_size=args['batch_size'], learning_rate=args['learning_rate'], augmented=False)
    print("*" * 100)
    ...
    augmented_model = Model(augmented_train_feat_vec, augmented_train_labels, original_test_feat_vec, test_labels,
                            model_weights, out_folder, \
                            isModelWeightsAvailable=args['isModelWeightsAvailable'], epochs=args['epochs'],
                            batch_size=args['batch_size'], learning_rate=args['learning_rate'], augmented=True)
